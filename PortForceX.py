...
def usage():
    ...
    print("-P --pass            - set a list of passwords to brute force")
    print()
    print("Examples:")
    print("---------------------------------------------")
...
def main():
    ...
    print(bcolors.OKGREEN + "[+] Pinging %s to verify host connectivity...\n" % (target) + bcolors.ENDC)
    time.sleep(3)
